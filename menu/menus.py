...
class MenuGenerator:
    ...
    def create_message(self, page: list, show_results: int, item_to_show: int, channel_id: str) -> tuple[str, str]:
        """
    ...
    def create_choices(self, page: list, show_results: int, channel_id: str) -> tuple:
        """
        Create menu options
    ...
    def choice_handler(self, menu_items, selected_item: int, menu_level: str, page: list, user_input: str,
        ...
        """
        if menu_items(selected_item).name == 'Check_for_updates':
...
class MyFavotrite(MenuGenerator):
    ...
    def create_choices(self, page: list, show_results: int, channel_id: str) -> tuple[list, int]:
...
class FoundChannels(MenuGenerator):
    ...
    def choice_handler(self, menu_items, selected_item: int, menu_level: str, page: list, user_input: str,
                       ...
                       show_results: int) -> tuple[str, list, str, str, int]:
        if selected_item < results_amount:
            yt.add_fav_channel(page[0], show_results, selected_item)
        elif menu_items(selected_item).name == 'Forward':
            page[0] += 1
        elif menu_items(selected_item).name == 'Back':
            page[0] -= 1
...
class ChannelData(MenuGenerator):
    ...
    def create_message(self, page: list, show_results: int, item_to_show: int, channel_id: str) -> tuple[str, str]:
        channel_id, *chosen_channel_data = self.db.show_my_channels(page[0], show_results)[0][item_to_show]
...
class ChannelVideos(MenuGenerator):
    ...
    def create_choices(self, page: list, show_results: int, channel_id: str) -> tuple[list, int]:
        channel_videos_data, pages = self.db.show_channel_videos(page[1], show_results, channel_id)
    ...
    def choice_handler(self, menu_items, selected_item: int, menu_level: str, page: list, user_input: str,
        ...
        if selected_item < results_amount:
            item_to_show = selected_item
            yt.playback_video(page[1], show_results, selected_item, channel_id)
        elif menu_items(selected_item).name == 'Forward':
            page[1] += 1
        elif menu_items(selected_item).name == 'Back':
            page[1] -= 1
